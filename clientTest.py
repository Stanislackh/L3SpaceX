...
# client.bind((adresseIP, portServeur))  # Lie l'adresse à la socket
...
errorDico = {
    ...
    "211": "le pseudo rentré est trop long ou trop long doit être compris entre 3 et 10 caractères",
...
# Fonction pour communiquer avec le serveur par envoi de messages
...
while message != "QUIT":
    ...
    if message == "HELP":  # Renvoie la liste des commandes disponibles
        ...
        reponse = afficheLaReponse(data)  # Fait appel a la fonction qui permet de regarder les codes reçus
